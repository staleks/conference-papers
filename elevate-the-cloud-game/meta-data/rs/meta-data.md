...
Subtitle: Primeri iz stvarnog života (produkcioni primeri) o tome kako uštedeti i pri tome skalirati rešenje u cilju postizanju uspeha.
...
Cloud computing je donelo revoluciju u načinu na koji organizacije upravljaju infrastrukturom i aplikacijama, dajući im neuporedivu fleksibilnost i skalabilnost. Međutim, pravi potencijal cloud platformi kao što je Amazon Web Services (AWS) leži u optimizaciji troškova kako bi smo izvukli maksimum vrednosti iz proizvoda. Pridružite nam se na zanimljivoj prezentaciji u kojoj ulazimo u svet optimizacije troškova AWS-a, istražujući različite strategije i najbolje prakse koje će unaprediti način na koji koristite cloud.

U prvom delu prezentacije, demistifikovaćemo umetnost optimizacije troškova, otkrivajući tehnike koje mogu pomoći vašoj organizaciji da minimizira troškove bez žrtvovanja performansi ili skalabilnosti. Od pravljenja instanci i optimizacije troškova skladištenja i prenosa podataka do inteligentnog upravljanja computing power-a i kontejnerizacije. Pružićemo vam uvide koji se mogu primeniti da biste ostvarili značajne uštede.
